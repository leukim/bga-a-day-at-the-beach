 ...
 * -----
 *
 * adayatthebeachmiquel.action.php
 *
 * ADayAtTheBeachMiquel main action entry point
 *
 *
 ...
 */
class action_adayatthebeachmiquel extends APP_GameAction
{
    /**
    ...
    public function __default()
    {
        ...
        {
            $this->view = "adayatthebeachmiquel_adayatthebeachmiquel";
